...
exp.grafico1 <- ggplot(Experimento, aes(Dosis, Altura, linetype= Complemento)) + geom_point() + geom_line() + theme_classic()
exp.grafico1
...
exp.grafico3 <- ggplot(Experimento, aes(Dosis, Altura, color= Complemento)) + geom_point() + geom_line(aes(linetype= Complemento)) + geom_errorbar(aes(ymin=Altura-Error_Altura, ymax=Altura+ Error_Altura), width=.1, position=position_dodge(0.05)) + scale_color_brewer(palette = "Reds") + theme_classic()
exp.grafico3

...
iris.grafico1 <- ggplot(iris.tidy, aes(Species, Value)) + geom_point()
iris.grafico1

#Modificamos para que visualizar la variable Part
iris.grafico2 <- ggplot(iris.tidy, aes(Species, Value, color= Part)) + geom_point()
iris.grafico2
...
iris.grafico4 <- ggplot(iris.tidy, aes(Species, Value, color= Part)) + geom_jitter()
iris.grafico4
